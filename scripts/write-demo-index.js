...
function usage() {
  return `Usage:
  node ./scripts/write-demo-index.js <log.jsonl> [--out index.html] [--brief JUDGE_BRIEF.md] [--replay-html replay.html] [--arena-html arena.html] [--leaderboard leaderboard.md] [--comparison-json agent-comparison.json]
